...
from keyboards.inline.prodyct_inline import product_plus_minus
from keyboards.default.products_kb import make_product_keyboard
from keyboards.default.products_kb import make_cart_sub_keyboard
# states
...
async def show_cart_handler(message: Message, state: FSMContext):
    ...
    await message.answer(main.text)
